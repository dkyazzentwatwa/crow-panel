...
//   EXTRA_FLAGS="-DUSE_PN532_DRIVER=1" ./scripts/compile-all.sh

#define BADGEOPS_API_ENDPOINT "http://localhost:8787"

// Local hardware worksheet (gitignored copy of Pins.example.h): PN532
// IRQ/RESET pins, MFRC522 SS/RST overrides.
