// Project Inkwell (crow-panel project 25) -- vendored dependency.
// miniz version 3.0.2, single-file amalgamation.
// Source: https://github.com/richgel999/miniz/releases/download/3.0.2/miniz-3.0.2.zip
// License: MIT (see LICENSE text embedded in miniz.c's header comment).
// Vendored unmodified below this comment.
#ifndef MINIZ_EXPORT
#define MINIZ_EXPORT
#endif
