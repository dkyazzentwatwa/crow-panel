...
- `./scripts/test-litego.sh --quick`, `./scripts/test-cypher-desk.sh`, `python3 scripts/test-flock-catalog.py`, `python3 scripts/test-flock-protocol.py`, `./scripts/compile-flock-system.sh`: host-side tests that need no board.
