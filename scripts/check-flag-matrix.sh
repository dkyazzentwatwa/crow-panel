...
P16="projects/16-cypher-flock-panel"
...
ROWS=(
  ...
  "$P18|full-os|-DUSE_DISPLAY=1 -DUSE_CYPHER_DESK_SD=1 -DUSE_WIFI=1 -DUSE_CYPHER_DESK_AUDIO=1 -DUSE_CYPHER_DESK_MEDIA=1 -DUSE_CYPHER_DESK_RECORDER=1|GFX Library for Arduino,SensorLib,U8g2"
